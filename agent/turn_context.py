...
def build_turn_context(
    ...
    *,
    ...
    # Preserve the cached external-memory prefetch on the agent for post-loop
    # finalizers/gateway metadata. The loop also receives it as a local, but
    # finalization now lives in agent.turn_finalizer.
